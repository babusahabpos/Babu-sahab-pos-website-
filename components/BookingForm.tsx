...
import { RegistrationData, RegistrationRequest } from '../types';
...
const BookingForm: React.FC = () => {
    ...
    return (
      <div className="bg-[#121212] py-32 flex items-center justify-center min-h-[600px]">
        <div className="text-center">
          ...
          <h3 className="text-xl font-bold text-white uppercase tracking-widest">Processing Secure Registration...</h3>
  ...
  if (step === 'success') {
    return (
      <div className="bg-white p-10 rounded-[2rem] shadow-2xl text-center border border-yellow-100 max-w-xl mx-auto my-20 animate-in zoom-in duration-500">
        ...
        <h3 className="text-3xl font-black text-slate-900 mb-4 uppercase tracking-tighter">Registration Sent!</h3>
  ...
  return (
    <section id="registration" className="py-24 bg-[#121212] text-white overflow-hidden relative border-t border-white/5">
        ...
        <div className="lg:grid lg:grid-cols-2 lg:gap-20 items-center">
          <div>
            ...
            <h2 className="text-4xl font-[1000] sm:text-6xl mb-8 uppercase tracking-tighter leading-none">
              Free <br/> <span className="text-yellow-400">Registration</span>
            </h2>
          ...
          <div className="relative group">
            ...
            <div className="relative bg-white rounded-[2.5rem] p-8 lg:p-12 shadow-2xl">
              <h3 className="text-2xl font-black text-slate-900 mb-8 text-center uppercase tracking-tighter">Business Registration</h3>
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid grid-cols-1 gap-6">
                  <div>
                    <label className="block text-[10px] font-black text-slate-400 mb-2 uppercase tracking-[0.2em]">Restaurant Name</label>
                    <input
                      required
                      type="text"
                      name="restaurantName"
                  ...
                  <div>
                    <label className="block text-[10px] font-black text-slate-400 mb-2 uppercase tracking-[0.2em]">Mobile Number</label>
                    <input
                      required
                      type="tel"
                      name="phone"
                  ...
                  <div>
                    <label className="block text-[10px] font-black text-slate-400 mb-2 uppercase tracking-[0.2em]">Gmail</label>
                    <input
                      required
                      type="email"
                      name="email"
