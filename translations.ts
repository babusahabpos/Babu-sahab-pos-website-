...
export const translations = {
  en: {
    ...
    heroOffer: "FREE 6 MONTH SUBSCRIPTION | FAST 100 USER",
    demoBtn: "FREE REGISTRATION",
    downloadBtn: "Download APK",
    licenseInfo: "Premium License: ₹99/monthly",
    reviewBtnLabel: "Customer Reviews",
    ...
    whyPoints: [
      "FAST 6 MONTH SUBSCRIPTION FREE",
  ...
  bn: {
    ...
    heroOffer: "ফ্রি ৬ মাসের সাবস্ক্রিপশন | দ্রুত ১০০ ইউজার",
    demoBtn: "ফ্রি রেজিস্ট্রেশন",
    downloadBtn: "APK ডাউনলোড করুন",
    licenseInfo: "প্রিমিয়াম লাইসেন্স: ৯৯ টাকা/মাস",
    reviewBtnLabel: "কাস্টমার রিভিউ",
    writeReview: "রিভিউ লিখুন",
    submitReview: "রিভিউ জমা দিন",
    ratingLabel: "আপনার রেটিং",
    namePlaceholder: "আপনার নাম",
    commentPlaceholder: "আপনার অভিজ্ঞতা শেয়ার করুন...",
    replyBtn: "রিপ্লাই",
    ...
    whyPoints: [
      "দ্রুত ৬ মাসের সাবক্সক্রিপশন ফ্রি",
